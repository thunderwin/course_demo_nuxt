...
import { parseQuery, hasProtocol, joinURL, withQuery, withTrailingSlash, withoutTrailingSlash, isScriptProtocol } from 'file:///Users/nate/codewarehouse/course/nate_blog/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrRenderClass, ssrInterpolate } from 'file:///Users/nate/codewarehouse/course/nate_blog/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BStKKHEB.mjs')
  },
  {
    name: "about-us",
    path: "/about-us",
  ...
  },
  {
    name: "contact-us",
    path: "/contact-us",
    component: () => import('./contact-us-BMupWWf5.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DqKKX8E_.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-C7IL-wn3.mjs'));
